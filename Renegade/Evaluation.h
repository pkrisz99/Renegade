...
constexpr EvaluationFeatures Weights = {
	...
	// 2.1 Pawn PSQT
	S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(-18, 29), S(-18, 41), S(-10, 29), S(-12, 31), S(-1, 40), S(29, 23), S(38, 19), S(0, 9), S(-27, 21), S(-26, 29), S(-16, 16), S(-15, 21), S(-2, 21), S(-2, 16), S(16, 14), S(-4, 4), S(-22, 27), S(-23, 39), S(-11, 16), S(2, 11), S(2, 13), S(7, 11), S(2, 24), S(-4, 9), S(-18, 47), S(-16, 47), S(-9, 26), S(-6, 10), S(15, 9), S(19, 9), S(10, 31), S(9, 21), S(-11, 94), S(-26, 117), S(6, 72), S(5, 49), S(13, 41), S(62, 41), S(39, 86), S(15, 77), S(95, 200), S(92, 199), S(61, 206), S(115, 158), S(64, 164), S(79, 161), S(6, 209), S(-2, 210), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
	...
	S(0, 0), S(-29, 1), S(-16, 3), S(-14, -19), S(-6, -41), S(-3, -104), S(-40, -116), S(0, 0),

	// 5.3 Isolated pawns by file
	S(-7, 2), S(-5, -9), S(-13, -7), S(-11, -17), S(-12, -16), S(-13, -6), S(-2, -11), S(-4, 1),
	...
	S(0, 0), S(0, 0), S(17, 13), S(12, 7), S(16, 15), S(39, 24), S(118, 39), S(0, 0),
