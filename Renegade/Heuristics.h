...
public:
	...
	// Transposition table
	void AddTranspositionEntry(const uint64_t hash, const uint16_t age, const int depth, int16_t score, const int scoreType, const Move& bestMove, const int level);
