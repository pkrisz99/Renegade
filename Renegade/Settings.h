...
ADD_TUNABLE(nnlmr_0, -323, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_1, -200, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_2, 551, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_3, 1381, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_4, 113, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_5, -648, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_6, 1734, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_7, 1225, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_8, -1035, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_9, 655, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_10, -1258, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_11, -664, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_12, 435, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_13, -1194, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_14, -1459, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_15, -646, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_16, -1149, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_17, -1, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_18, -1439, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_19, -1564, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_20, 267, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_21, -440, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_22, 109, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_23, -1392, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_24, -71, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_25, 863, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_26, -800, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_27, 224, -4000, 4000, 100)
ADD_TUNABLE(nnlmr_28, 411, -4000, 4000, 100)
