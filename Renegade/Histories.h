...
public:
	...
	void SetThreatRefutationMove(const Position& pos, const Move& thisMove);
	Move GetThreatRefutationMove(const Position& pos) const;
...
private:
	...
	MultiArray<Move, 2, 32768> ThreatMoves;
