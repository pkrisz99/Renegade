...
private:
	...
	using QuietHistoryTable = std::array<std::array<ThreatBuckets, 64>, 13>;
	using CaptureHistoryTable = std::array<std::array<std::array<ThreatBuckets, 13>, 64>, 13>;  // [attacking piece][square to][captured piece]
	using ContinuationHistoryTable = std::array<std::array<std::array<std::array<int16_t, 64>, 13>, 64>, 13>;

	using QuietHistoryStructureTable = std::array<std::array<std::array<std::array<uint16_t, 2>, 2>, 64>, 13>;
	...
	using FollowUpCorrectionTable = std::array<std::array<std::array<std::array<int32_t, 64>, 13>, 64>, 13>;
