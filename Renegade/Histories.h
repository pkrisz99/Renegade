...
public:
	...
	bool IsCountermove(const uint64_t pawnHash, const Move& previousMove, const Move& thisMove) const;
...
private:
	...
	std::array<std::array<std::pair<Move, uint16_t>, 64>, 64> CounterMoves;
